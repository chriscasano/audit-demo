...
echo ""
echo "Go to the NiFi UI (http://localhost:9095/nifi) and make sure all of the Controller Services are running and start your flow."
read -p "...Did you update the Controller Services and start the flow processors?" cs
